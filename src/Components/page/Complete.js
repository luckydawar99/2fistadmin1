...
import { TbAtomOff, TbPlayerEjectFilled } from 'react-icons/tb';
...
const Complete = () => {
    ...
    const tableData = [
        { SR: 1, TeamName: "Indore vs Bhopal", Date: "2023-01-05 ", Totaltime: "12:22:05", StartTime: "2500", EndTime: "758247", TotalPayment: "250", TotalBetUser: "9", Status: "Complete" },

        { SR: 2, TeamName: "Indore vs dewas", Date: "2023-01-05 ", Totaltime: "12:22:05", StartTime: "2500", EndTime: "758247", TotalPayment: "250", TotalBetUser: "9", Status: "Complete" },

        { SR: 3, TeamName: "ujjain vs Bhopal", Date: "2023-01-05 ", Totaltime: "12:22:05", StartTime: "2500", EndTime: "758247", TotalPayment: "250", TotalBetUser: "9", Status: "Complete" },

        { SR: 4, TeamName: "Indore vs Bhopal", Date: "2023-01-05 ", Totaltime: "12:22:05", StartTime: "2500", EndTime: "758247", TotalPayment: "250", TotalBetUser: "9", Status: "Complete" },

        { SR: 5, TeamName: "Indore vs Bhopal", Date: "2023-01-05 ", Totaltime: "12:22:05", StartTime: "2500", EndTime: "758247", TotalPayment: "250", TotalBetUser: "9", Status: "Complete" },
                        ...
                        <div className="page-header pb-0 border-0 mb-3 mt-3 ">
                            <div className="d-flex flex-wrap gap-2 align-items-center mb-3 mt-3 pl-3">
                                <h2 className="h1 mb-0 d-flex gap-2">
                                    <TbAtomOff className='mt-1' style={{ fontSize: "18px" }} />
                                    Confirmed Match
                                </h2>
                            </div>
                        </div>
