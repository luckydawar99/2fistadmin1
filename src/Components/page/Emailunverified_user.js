    ...
    return (
      <>
        ...
        <tr id={`data-${index}`}>
          ...
          <td>
            {
              usersdata?.userProfile === " " || usersdata?.userProfile === null || usersdata?.userProfile === undefined ? (
                <img style={{ width: "50%" }}
                  src="./img/logo/blank-profile-picture.webp"
                />
              ) : usersdata?.userProfile?.startsWith("https://") ? (
                <img style={{ width: "50%" }}
                  src={`${process.env.REACT_APP_IMG_URL}${usersdata?.userProfile}`} alt=""
                />
              ) : (
                <img style={{ width: "50%" }}
                  src={`${process.env.REACT_APP_IMG_URL}${usersdata?.userProfile}`} alt=""
...
export default Emailunverified_user;
