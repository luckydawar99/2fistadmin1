  ...
  const renderProductData = (data, index) => {
    ...
    return (
      <tr>
        ...
        <td className="text-center">Yes Bank</td>
        <td className="text-center">7485</td>
        <td className="text-center">474</td>
        <td className="text-center">47,000</td>
        <td className="text-center">This is convey of details</td>

        <td>Dangler earrings elegantly</td>
