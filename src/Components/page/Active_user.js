...
import { FaClipboardList, FaCommentDollar, FaCreativeCommonsBy, FaRegStopCircle } from 'react-icons/fa';
...
const Active_user = () => {
  ...
  const tableData = [
    { SR: 1, TeamName: "Indore vs Bhopal", Date: "2023-01-05 ", Totaltime: "12:22:05", StartTime: "2500", EndTime: "758247", TotalPayment: "250", TotalBetUser: "9", Status: "Active" },

    { SR: 2, TeamName: "Indore vs dewas", Date: "2023-01-05 ", Totaltime: "12:22:05", StartTime: "2500", EndTime: "758247", TotalPayment: "250", TotalBetUser: "9", Status: "Active" },

    { SR: 3, TeamName: "ujjain vs Bhopal", Date: "2023-01-05 ", Totaltime: "12:22:05", StartTime: "2500", EndTime: "758247", TotalPayment: "250", TotalBetUser: "9", Status: "Active" },

    { SR: 4, TeamName: "Indore vs Bhopal", Date: "2023-01-05 ", Totaltime: "12:22:05", StartTime: "2500", EndTime: "758247", TotalPayment: "250", TotalBetUser: "9", Status: "Active" },

    { SR: 5, TeamName: "Indore vs Bhopal", Date: "2023-01-05 ", Totaltime: "12:22:05", StartTime: "2500", EndTime: "758247", TotalPayment: "250", TotalBetUser: "9", Status: "Active" },
    ,
  ];
            ...
            <div className="page-header pb-0 border-0 mb-3 mt-3 ">
              <div className="d-flex flex-wrap gap-2 align-items-center mb-3 mt-3 pl-3">
                <h2 className="h1 mb-0 d-flex gap-2">
                  <FaCreativeCommonsBy className='mt-1' style={{ fontSize: "18px" }} />
                Active user
                </h2>
              </div>
            </div>
                ...
                <tbody>
                  {tableData.map((data, index) => (
                    <tr key={index}>
                      ...
                      <td>
                        <td className='order-stats__subtitle d-inline-flex' style={{ lineHeight: "12px", color: "green", border: "1px solid green", padding: "5px" }}>{data.Status}</td>
                      </td>
