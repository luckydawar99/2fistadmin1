  ...
  return (
    ...
    >
      ...
      <div className="d-flex flex-wrap gap-2 align-items-center mb-3">
        ...
        <span className="badge badge-soft-dark radius-50 fz-14">70</span>
      </div>
      <div className="card">
        <div className="card-body">
          <form action="https://6valley.6amtech.com/admin/orders/list/delivered" id="form-data" method="GET">
            <div className="row gx-2">
              ...
              <div className="col-12">
                <div className="d-flex gap-3 justify-content-end">
                  <a href="https://6valley.6amtech.com/admin/orders/list/delivered" className="btn btn-secondary px-5">
                    Reset
                  </a>
                  <button type="submit" className="btn btn--primary px-5" onclick="formUrlChange(this)" data-action="https://6valley.6amtech.com/admin/orders/list/delivered">
                    Show data
                  </button>
                </div>
              </div>
            ...
            <div className="row g-2 align-items-center flex-grow-1">
              <div className="col-md-4">
                <h5 className="text-capitalize d-flex gap-1">
                  Order list
                  <span className="badge badge-soft-dark radius-50 fz-12">70</span>
                </h5>
              </div>
              <div className="col-md-8 d-flex gap-3 flex-wrap flex-sm-nowrap justify-content-md-end">
                ...
                <div className="dropdown">
                  ...
                  <ul className="dropdown-menu dropdown-menu-right">
                    <li>
                      <a type="submit" className="dropdown-item d-flex align-items-center gap-2" href="https://6valley.6amtech.com/admin/orders/export-order-data/delivered">
            ...
            <div className="d-flex justify-content-lg-end">
              <nav>
                <ul className="pagination">
                  ...
                  <li className="page-item"><a className="page-link" href="https://6valley.6amtech.com/admin/orders/list/delivered?page=2">2</a></li>
                  <li className="page-item"><a className="page-link" href="https://6valley.6amtech.com/admin/orders/list/delivered?page=3">3</a></li>
                  <li className="page-item">
                    <a className="page-link" href="https://6valley.6amtech.com/admin/orders/list/delivered?page=2" rel="next" aria-label="Next »">›</a>
                  </li>
                </ul>
              </nav>
            </div>
...
export default Deliverdproducs
